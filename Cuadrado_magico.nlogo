...
globals [psize matrix]

to setup
  clear-all
  reset-ticks
  ask patches [set pcolor white]
  set psize 40 ;variable del tamaño de las parcelas
  set-default-shape turtles "circle" ;establece la forma de la tortuga a circular
  resize-world 0 2 0 2 ;redimensiona el mundo al tamaño del tablero
  ...
  set matrix new-matrix 3 3 ;crea la matriz del tablero
end
